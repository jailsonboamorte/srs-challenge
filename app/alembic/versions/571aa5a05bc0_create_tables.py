...
Revision ID: 571aa5a05bc0
Revises: 
Create Date: 2025-08-24 16:17:54.251561
...
def upgrade() -> None:
    ...
    op.execute('DROP TYPE IF EXISTS modelstateenum;')
    op.execute('DROP TYPE IF EXISTS modelcityenum;')
    op.create_table('addresses',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('state', sa.Enum('AC', 'AL', 'AP', 'AM', 'BA', 'CE', 'DF', 'ES', 'GO', 'MA', 'MT', 'MS', 'MG', 'PA', 'PB', 'PR', 'PE', 'PI', 'RJ', 'RN', 'RS', 'RO', 'RR', 'SC', 'SP', 'SE', 'TO', name='modelstateenum'), nullable=False),
    sa.Column('city', sa.Enum('RIO_BRANCO', 'MACEIO', 'MACAPA', 'MANAUS', 'SALVADOR', 'FORTALEZA', 'BRASILIA', 'VITORIA', 'GOIANIA', 'SAO_LUIS', 'CUIABA', 'CAMPO_GRANDE', 'BELO_HORIZONTE', 'BELEM', 'JOAO_PESSOA', 'CURITIBA', 'RECIFE', 'TERESINA', 'RIO_DE_JANEIRO', 'NATAL', 'PORTO_ALEGRE', 'PORTO_VELHO', 'BOA_VISTA', 'FLORIANOPOLIS', 'SAO_PAULO', 'ARACAJU', 'PALMAS', name='modelcityenum'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('category', sa.Enum('national', 'international', name='modelcategoryenum'), server_default='national', nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.execute('DROP TYPE IF EXISTS modelstatusenum;')
    op.create_table('crops',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('farm_id', sa.Integer(), nullable=False),
    sa.Column('harvest_id', sa.Integer(), nullable=False),
    sa.Column('arabel_area', sa.Integer(), nullable=False, comment='Área agricultável'),
    sa.Column('status', sa.Enum('canceled', 'finished', 'started', name='modelstatusenum'), nullable=False),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.TIMESTAMP(), nullable=True),
