...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "inactive", name="modelproducersstatusenum"),
    ...
    op.create_table(
        ...
        sa.Column(
            "total_area", sa.Integer(), nullable=False, comment="Área total da fazenda"
        ),
        sa.Column(
            "arable_area", sa.Integer(), nullable=False, comment="Área agricultável"
        ),
        sa.Column(
            "vegetation_area", sa.Integer(), nullable=False, comment="Área de vegetação"
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP(),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("canceled", "finished", "started", name="modelcropsstatusenum"),
            nullable=False,
